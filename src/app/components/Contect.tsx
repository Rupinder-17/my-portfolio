          ...
          >
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-3 sm:p-4 md:p-6 h-full flex flex-col shadow-lg">
              ...
              <div className="space-y-2 sm:space-y-3 md:space-y-6 flex-1">
                ...
                <a
                  href="https://wa.me/919530654704?text=Hi%20Rupinder%2C%20I%20visited%20your%20portfolio%20and%20would%20like%20to%20connect!"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-2 sm:space-x-3 md:space-x-4 group"
                >
                  <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-12 md:h-12 bg-green-500/20 backdrop-blur-sm rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-green-500/30 transition-colors">
                  ...
                  <div className="flex-1">
                    <h3 className="text-white font-semibold text-xs sm:text-sm md:text-base group-hover:text-green-400 transition-colors">WhatsApp</h3>
                    <p className="text-gray-300 text-xs sm:text-xs md:text-sm">+91 95306 54704</p>
                  </div>
                </a>
              </div>
